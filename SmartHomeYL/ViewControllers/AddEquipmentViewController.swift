...
//        if (peripheral.name?.hasPrefix("apple"))! {
...
//
//        //建立字典（传来的第iget个getDatas，其中存储的temprature）
//        var getDictionary = [Int: String]()
//        getDictionary[iget] = getText
//
//        //存入数据库
//        let realm = try! Realm()
//
//        for _ in getDictionary {
//            let item = getDatas()
//            item.id = iget
//            item.temprature = getText!
//            item.date = Date(timeIntervalSinceNow: 0)
//            try! realm.write {
//                realm.add(item)
//            }
//            print("收到的第\(iget)个温度是 \(item.temprature)")
//            //            打印出数据库地址
...
//        //            realm.deleteAll()
//        //        }
//        //        print("getDatas数据库里现在有 \(getDatas())")
//    }
//
//    /** 传出数据 */
